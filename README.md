...
6.2 Data Flow
Ingestion: Raw data is cleaned and validated against the system schema.
Standardization: Data is merged with Dimension Tables (Awards, Pay Rates).
Calculation: The Engine iterates through the Fact Table at a Daily Granularity to apply time-based rules.
Export: Results are visualized and exported as PDF/Excel for litigation support.
6.3 Key Components
